...
(library Library_1
	...
	(patternDef "PC722A" (originalName "PC722A")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.443, 0.000) (textStyleRef "Default") (isVisible True))
		)
	...
	(symbolDef "PC722A" (originalName "PC722A")
		...
		(pin (pinNum 3) (pt 2500 mils 0 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 2270 mils -25 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "PC722A" (originalName "PC722A") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(compPin "1" (pinName "PIN TERMINAL") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "SLEEVE SHUNT TERMINAL") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "SLEEVE TERMINAL") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.switchcraft.com/Drawings/pc722a_cd.pdf")
	)
